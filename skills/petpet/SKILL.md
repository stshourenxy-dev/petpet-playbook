...
> 让 AI 助手（Claude Code / OpenClaw 等）能正确地为 PetPet Playbook 项目工作：
...
4. **发布**：改文档要过 `docs/审查清单.md`（身份假设/错误路径/迭代残留/边界量纲/可访问性/文档一致性六维）

## 边界（诚实标注）

- 客户端只在 macOS 实测，Windows 未上真机验证——别宣称"支持 Windows"
